...
namespace CaptureSnippets
{
    ...
    /// </summary>
    public class GroupedProcessResult : IEnumerable<SnippetGroup>
    {

        public GroupedProcessResult(IReadOnlyList<SnippetGroup> usedSnippets, IReadOnlyList<MissingSnippet> missingSnippets)
        {
